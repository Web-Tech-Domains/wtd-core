...
final class ErrorPageRenderer
{
    public function render(Throwable $throwable, int $status, bool $debug): string
    {
        ...
        return '<!doctype html><html lang="en"><head><meta charset="utf-8"><title>'
            ...
            . $this->styles()
            . '</style></head><body><header class="topbar"><a class="brand" href="/"><span class="mark">W</span><span>WTD Core</span></a><nav><a href="/">Home</a><a href="/health">Health</a><a href="/docs/api">API Docs</a></nav></header><main class="wrap"><section class="hero"><div><span class="badge">HTTP '
            . $status
            . '</span><h1>'
            . $this->escape($title)
            . '</h1><p>'
